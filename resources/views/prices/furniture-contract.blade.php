    ...
    <form method="post" action="" id="f-contract" name="f-contract">
        ...
        <div id="input">
            <div id="menu">
                ...
                <div id="hdtc-them">
                    <div><a id="menu-hdtc-trongoi" href="https://azar.vn/hop-dong-thi-cong-khach-hang" class="btn btn-sub-nho" title="" data-toggle="tooltip" data-original-title="Hợp đồng thi công trọn gói">HĐTC trọn gói</a></div>
                    <div><a id="menu-hdtc-noithat" href="https://azar.vn/hop-dong-thi-cong-noi-that" class="btn btn-sub btn-sub-nho " title="" data-toggle="tooltip" data-original-title="Hợp đồng thi công nội thất">HĐTC nội thất</a></div>
                </div>
