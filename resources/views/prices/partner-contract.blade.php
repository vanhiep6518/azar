    ...
    <form method="post" action="" id="f-contract" name="f-contract">
        ...
        <div id="input">
            <div id="menu">
                ...
                <div><a id="menu-hdtckh" href="https://azar.vn/hop-dong-thi-cong-khach-hang" class="btn " title="" data-toggle="tooltip" data-original-title="Hợp đồng thi công khách hàng">Hợp đồng thi công KH</a></div>
                <div><a id="menu-hdtcdt" href="https://azar.vn/hop-dong-thi-cong-doi-tac" class="btn btn-light" title="" data-toggle="tooltip" data-original-title="Hợp đồng thi công đối tác">Hợp đồng thi công ĐT</a></div>
            </div>
            <div id="inputdata">
                <p></p>
        ...
        <div id="content">
            <div id="print-this">
                ...
                <table class="party" style="border:collapse; border: none; width: 100%;">
                    <tbody>
                    <tr>
                        <th width="50%">BÊN A: <span class="office_info_auto-name">CÔNG TY CỔ PHẦN TƯ VẤN THIẾT KẾ &amp; XÂY DỰNG AZAR</span></th>
