...
@section('content')
    <div id="content" class="container-fluid">
        <div class="card">
            ...
            @endif
            <div class="card-body">
                <form method="POST" action="{{route('admin.saveProduct',['id' => $project->id])}}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="name">Tên sản phẩm</label>
                        <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" id="name" value="{{$project->name}}">
                        @error('name')
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" id="inputPassword4" value="{{$project->code}}">
                            @error('code')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="short_desc" class="form-control @error('short_desc') is-invalid @enderror" name="short_desc">{{$project->short_desc}}</textarea>
                        @error('short_desc')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="mytextarea" class="form-control @error('detail') is-invalid @enderror" name="detail">{{$project->detail}}</textarea>
                        @error('detail')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
