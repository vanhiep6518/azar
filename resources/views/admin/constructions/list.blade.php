...
@section('content')
    <div id="content" class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <div class="analytic">
                    <a href="{{route('admin.construction',['status'=> 1])}}" class="text-primary">Công khai<span class="text-muted">({{$numberStatus['public']}})</span></a>
                    <a href="{{route('admin.construction',['status'=> 2])}}" class="text-primary">Chờ duyệt<span class="text-muted">({{$numberStatus['private']}})</span></a>
                    <a href="{{route('admin.construction',['status'=> 3])}}" class="text-primary">Thùng rác<span class="text-muted">({{$numberStatus['trash']}})</span></a>
                </div>
                <form action="{{route('admin.actionConstruction')}}" method="POST">
                    @csrf
