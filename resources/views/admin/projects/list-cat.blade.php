            ...
            <div class="col-4">
                <div class="card cat-info">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.addProjectCat')}}" method="POST">
                            @csrf
                                ...
                                @foreach($listCat as $key => $item)
                                    <tr>
                                        ...
                                        <td class="feature">
                                            ...
                                            <a href="{{route('admin.deleteProjectCat',['id'=>$item->id])}}" data-id="{{$item->id}}" class="btn btn-danger btn-sm rounded-0 text-white btn-delete" type="button" onclick="return confirm('Dữ liệu bài viết sẽ bị xoá nếu bạn xoá danh mục này')"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
