...
@section('content')
    <div id="content" class="container-fluid">
        <div class="card">
            ...
            @endif
            <div class="card-body">
                <form method="POST" action="{{route('admin.saveProject')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="floors" class="form-control @error('floors') is-invalid @enderror" id="inputPassword4" value="{{ old('floors') }}">
                            @error('floors')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="acreage" class="form-control @error('acreage') is-invalid @enderror" id="inputPassword4" value="{{ old('acreage') }}">
                            @error('acreage')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
