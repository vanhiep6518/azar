                ...
                <form method="POST" action="{{route('admin.saveProject',['id' => $project->id])}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="status" id="exampleRadios1" value="2" @if ($project->status == 2)
                                checked
                            @endif>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="status" id="exampleRadios2" value="1" @if ($project->status == 1)
                            checked
                        @endif>
