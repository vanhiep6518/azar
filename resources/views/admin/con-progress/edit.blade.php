...
@section('content')
    <div id="content" class="container-fluid">
        <div class="card">
            ...
            @endif
            <div class="card-body">
                <form method="POST" action="{{route('admin.saveProgress',['id'=>$project->id])}}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="name">Mã tiến độ</label>
                        <input class="form-control @error('code') is-invalid @enderror" type="text" name="code" id="name" value="{{ $project->code }}">
                        @error('code')
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('custmer_name') is-invalid @enderror" type="text" name="customer_name" id="name" value="{{ $project->customer_name }}">
                        @error('customer_name')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
